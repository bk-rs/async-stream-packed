/*
cargo run -p async-stream-packed-demo-async-std --bin unionable httpbin.org 80 false /ip
cargo run -p async-stream-packed-demo-async-std --bin unionable httpbin.org 443 true /ip
*/
